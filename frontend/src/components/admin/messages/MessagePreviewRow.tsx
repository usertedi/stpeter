        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-start justify-between gap-3">
              <p className={`truncate text-sm ${isUnread ? 'font-semibold text-gray-900' : 'font-medium text-gray-800'}`}>
                {message.name}
              </p>
            ...
            <p className={`mt-0.5 truncate text-sm ${isUnread ? 'font-medium text-gray-900' : 'text-gray-700'}`}>
              {message.subject}
            </p>
            <p className="mt-1 truncate text-xs text-gray-500">{message.email}</p>
          </div>
